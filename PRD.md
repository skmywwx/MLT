...
- [7. 下一阶段规划：Web 与小程序差异（P1）](#7-下一阶段规划web-与小程序差异p1)
...
| V2.9 | 2026-08-14 15:37 | 产品 | **明确本期原型以 Web 网页端为实现重点**；微信小程序下调至 P1 下一原型阶段；§7 调整为下一阶段双端差异规划；更新功能边界、待澄清项与异常场景。 |
...
> 本期原型实现：**Web 网页端**的本地上传照片收纳 + 基本账号/个人中心 + 电子相册编辑美化；**不含云存储**（待 P1）；**不含微信小程序**（下一原型阶段，见 P1 与 §7）。
...
> **实现范围**：本期所有功能均在 **Web 浏览器**中交付与演示；交互按鼠标 + 键盘优化（拖拽、滚轮、快捷键等）。
...
> 小程序触控交互与双端差异见 [§7 下一阶段规划（P1）](#7-下一阶段规划web-与小程序差异p1)。
...
> 小程序端编辑与预览适配见 [§7](#7-下一阶段规划web-与小程序差异p1)。
