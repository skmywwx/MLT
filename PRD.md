...
4. 状态名称和可用操作与本 PRD 状态规则一致。
5. 深度研究完整覆盖七个阶段，并能处理单任务失败和关键任务失败。
6. 最终结果支持复制和至少三种下载格式。
7. 最终结果后展示至少三个相关的“你可能想问”。
8. 文风选择可影响撰写结果，切换文风不会无故重跑检索任务。
9. Web 和桌面端核心入口、术语、状态与主要操作一致。
10. 所有异常状态都提供原因、影响范围和至少一个恢复动作。
